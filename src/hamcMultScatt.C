...
hamcMultScatt::hamcMultScatt() {
    InitInternal();

    return;
}

hamcMultScatt::hamcMultScatt( double p, int nmat, double t[], double A[], double Z[] ){
    /*
...
hamcMultScatt::hamcMultScatt( double p, double t, double A, double Z ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
void hamcMultScatt::InitInternal(){
    fInit = false;
...
void hamcMultScatt::Init( double p, int nmat, double t[], double A[], double Z[] ){
    /* 
...
void   hamcMultScatt::Init( double p, double t, double A, double Z ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
double hamcMultScatt::J0(double x) {
...
double hamcMultScatt::solvelogeq(double b){
...
double hamcMultScatt::fn_integrand( double u, double th, int n ){
...
double hamcMultScatt::intsimpson_fn( double th, int n ){
    ...
    //  most in 1.0 unit steps (1/sqrt sigmaish)
...
double hamcMultScatt::CalcMSDistPlane( double theta, double p, double t, double A, double Z ){
    Init( p, t, A, Z );
    return CalcMSDistPlane(theta);
}

double hamcMultScatt::CalcMSDistPlane( double theta, double p, int nmat, double t[], double A[], double Z[] ){
    Init( p, nmat, t, A, Z );
    return CalcMSDistPlane(theta);
}

double hamcMultScatt::CalcMSDistPlane( double theta){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
double hamcMultScatt::CalcMSDist( double theta, double p, double t, double A, double Z ){
    Init( p, t, A, Z );
    return CalcMSDist(theta);
}

double hamcMultScatt::CalcMSDist( double theta, double p, int nmat, double t[], double A[], double Z[] ){
    Init( p, nmat, t, A, Z );
    return CalcMSDist(theta);
}

double hamcMultScatt::CalcMSDist( double theta){
    return CalcMSDistPlane(theta)*sin(fabs(theta));
}

double hamcMultScatt::GenerateMSPlane(){
    /*
...
double hamcMultScatt::GenerateMSPlane( double p, int nmat, double t[], double A[], double Z[] ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
double hamcMultScatt::GenerateMSPlane( double p, double t, double A, double Z ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
double hamcMultScatt::GenerateMS(){
...
double hamcMultScatt::GenerateMS( double p, int nmat, double t[], double A[], double Z[] ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
...
double hamcMultScatt::GenerateMS( double p, double t, double A, double Z ){
    /*
       p    - electron momentum, [GeV]
       nmat - number of materials
       t    - Thickness [g/cm2]
